...
[**Stable release 1.5.0**](https://github.com/capisoft-lib/codex_usage/releases/tag/v1.5.0) · [Docker image 1.5.0](https://hub.docker.com/r/capitaine/codex-usage-dashboard) · [AGPL-3.0-or-later](LICENSE) · [Changelog](CHANGELOG.md) · [CI status](https://github.com/capisoft-lib/codex_usage/actions/workflows/ci.yml)
...
```text
capitaine/codex-usage-dashboard:1.5.0
```
...
$image = "capitaine/codex-usage-dashboard:1.5.0"
