...
import { ADDITIONAL_I18N, LOCALE_TAGS, THEME_I18N, TIME_FORMAT_I18N, MIGRATION_I18N, resolveLanguage } from "../public/translations.js";
...
test("fully translates every label used by the runtime", async () => {
  ...
  const english = { ...vm.runInNewContext(`({${englishBody}\n})`), ...PRICING_I18N.en, ...THEME_I18N.en, ...TIME_FORMAT_I18N.en, ...MIGRATION_I18N.en };

  for (const [language, baseMessages] of Object.entries(ADDITIONAL_I18N)) {
    const messages = { ...baseMessages, ...PRICING_I18N[language], ...THEME_I18N[language], ...TIME_FORMAT_I18N[language], ...MIGRATION_I18N[language] };
