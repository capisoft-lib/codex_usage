# Codex Usage Mesh — Sites hub

Optional authenticated aggregator for Codex Usage Mesh, running on
[vinext](https://github.com/cloudflare/vinext) with Cloudflare D1. It accepts
...
same route with `GET` remains protected by the Sites ChatGPT identity headers.
